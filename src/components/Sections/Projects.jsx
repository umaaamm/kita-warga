...
import AddImage2 from "../../assets/img4.png";
      ...
      <div className="lightBg">
        <div className="container">
          <Advertising className="flexSpaceCenter">
            ...
            <AddRight>
              <h4 className="font15 semiBold">Our Office</h4>
              <h2 className="font40 extraBold">kitawarga.com</h2>
              <p className="font12">
              Jl. KH Wahid Hasyim no. 33 Rt/rw. 004/004 Jurang Mangu Timur, Pondok Aren, Tangerang Selatan, Banten 15222.
              </p>
